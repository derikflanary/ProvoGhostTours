...
- (void)setupSelectionMaskLayer {
    ...
    _selectionMaskLayer.frame = CGRectMake(_pageItemWidth/2 - 27.5, 0.0, 55, _pageItemHeight);
    _selectionMaskLayer.backgroundColor = [[UIColor clearColor] colorWithAlphaComponent:0.1].CGColor;
}
